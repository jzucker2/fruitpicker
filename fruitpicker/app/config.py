...
ENV_FRUITPICKER_HOST = os.getenv(
    "FRUITPICKER_HOST",
    default="0.0.0.0")
...
class base_config(object):
    ...
    SITE_NAME = os.environ.get('APP_NAME', 'FRUITPICKER')

    SECRET_KEY = os.environ.get('SECRET_KEY', 'secrets')

    # WARNING: messing with the below breaks routing
    # SERVER_NAME = os.getenv("FRUITPICKER_HOST", default="0.0.0.0")
    FRUITPICKER_HOST = ENV_FRUITPICKER_HOST
    FRUITPICKER_PORT = ENV_FRUITPICKER_PORT
    ...
    FRUITPICKER_LOGGING_LEVEL = os.environ.get(
        'FRUITPICKER_LOGGING_LEVEL',
        logging.INFO)
